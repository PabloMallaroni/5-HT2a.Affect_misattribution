...
GA.freqConditions = [.3 .3 .3];    % 40% of the trials will be rests.
...
GA.cbalColinPowerWeights = [.5 1 1 .5];	% 1 = cbal, 2 = eff, 3 = hrf shape, 4 = freq
...
GA.NumStimthresh = [1];      % maximum number of repeats of any one event type in a row
